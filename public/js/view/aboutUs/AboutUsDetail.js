...
export default class AboutUsDetail extends React.Component {

  render() {

    return (
      <div id="wrainbo-aboutus-detail">
        <div class="row">
          ...
          <div class="wrainbo-aboutus-detail-text medium-6 columns">
            <h4>Smart game learning platform</h4>
            <p>
            ...
            <h4>Diverse team from business and gaming world</h4>
              <p>
