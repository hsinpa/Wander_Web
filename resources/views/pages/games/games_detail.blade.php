<div id="wrainbo-intro-detail" class="platform-detail">
          ...
          <section class="row">
            <div class="detailRow medium-6 columns">
              <div>
                  ...
                  <p>
                    Business Venture is a modern comic mobile game that helps build business acumen. Players will hone core business concepts of Marketing, Operations, and Finance by producing and trading apparel products and using  various business management tools.
                  </p>
              </div>
            </div>
        ...
        <div class="platformDetailPanel-1">
          <section class="row">
            <div class="detailRow medium-6 columns">
              <h5>21st Century Mentor</h5>
              <p>21st Century Mentor is a leadership game that teaches players how to adapt different leadership skills when dealing with employees with diverse cultural background, capabilities, and situations. The game will be available in early 2017!</p>
            </div>
