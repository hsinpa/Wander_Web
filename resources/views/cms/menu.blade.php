<div id="wrainbo-cms-menu">
  <ul>
    ...
    <a href="elementEditor"><li class="{{ $page=='elementEditor' ? 'menu-hightlight' : '' }}">Element Editor</li></a>
    <a href="spellEditor"><li class="{{ $page=='spellEditor' ? 'menu-hightlight' : '' }}">Tool Editor</li></a>
